...
# Lazy singleton so importing this module never fails before keys exist.
...
class _LazyClient:
    """Attribute proxy so `from or_client import client` keeps working."""
...
if __name__ == "__main__":
    ...
    print("\n[TEST 1] Basic chat...")
    try:
        reply = c.chat("Introduce yourself in one sentence.")
